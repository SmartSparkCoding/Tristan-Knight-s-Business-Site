...
The goal here is to create a professional but approachable first impression for photography clients. Everything from the layout to the interactions is meant to feel intentional and polished without being over the top. The site works well on mobile and desktop, with smooth scrolling between sections for portraits, events, and studio work done around Ashford, Kent.

Overall, it's a straightforward portfolio that gets the job done and looks good doing it. 
